...
async def login_to_bga(page, email: str, password: str, player_id: str):
    ...
    # The password form is a second form[name='login'] with a Login button.
    # It has a readonly username field first, then the actual password input.
...
async def main():
    ...
    async with async_playwright() as p:
        ...
        await login_to_bga(page, bga_email, bga_password, player_id)
        ...
        # Scrape details for each game using 5 concurrent tabs
        if games:
                ...
                async with sem:
                    for attempt in range(3):
                        ...
                        try:
                            ...
                            details["epoch_ms"] = game["epochMs"]
                            details["conceded"] = game["conceded"]
                            details["is_arena"] = game["isArena"]
            ...
            # Build JSON output — one record per player per game
            if all_details:
